...
class AlreadySetupError(BaseHTTPException):
    ...
    description = "Minha IA has been successfully installed. Please refresh the page or return to the dashboard homepage."
    code = 403
...
class NotSetupError(BaseHTTPException):
    ...
    description = (
        "Minha IA has not been initialized and installed yet. "
