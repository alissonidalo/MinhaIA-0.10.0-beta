...
When a model invocation error occurs, it should be mapped to the runtime's specified `InvokeError` type, enabling Minha IA to handle different errors appropriately.
