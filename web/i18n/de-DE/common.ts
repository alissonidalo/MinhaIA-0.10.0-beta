const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Minha IA-Konto',
    langGeniusAccountTip: 'Ihr Minha IA-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei Minha IA anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von Minha IA ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  apiBasedExtension: {
    title: 'API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in Minha IAs Anwendungen.',
  ...
  about: {
    ...
    nowAvailable: 'Minha IA {{version}} ist jetzt verfügbar.',
    latestAvailable: 'Minha IA {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
