const translation = {
  ...
  intro1: 'Das Wissen kann in die Minha IA-Anwendung ',
  intro2: 'als Kontext',
  intro3: ',',
  intro4: 'oder es ',
  ...
  externalAPIPanelDescription: 'Die API für externes Wissen wird verwendet, um eine Verbindung zu einer Wissensdatenbank außerhalb von Minha IA herzustellen und Wissen aus dieser Wissensdatenbank abzurufen.',
