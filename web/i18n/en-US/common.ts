const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Minha IA account',
    langGeniusAccountTip: 'Your Minha IA account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Minha IA to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Minha IA allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Minha IA\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Minha IA {{version}} is now available.',
    latestAvailable: 'Minha IA {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
