const translation = {
  ...
  welcome: 'Welcome to Minha IA, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Minha IA Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on Minha IA',
  invalid: 'The link has expired',
  explore: 'Explore Minha IA',
