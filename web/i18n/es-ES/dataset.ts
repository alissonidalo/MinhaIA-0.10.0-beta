const translation = {
  ...
  didYouKnow: '¿Sabías?',
  intro1: 'El Conocimiento se puede integrar en la aplicación Minha IA ',
  ...
  externalAPIPanelDescription: 'La API de conocimiento externo se utiliza para conectarse a una base de conocimiento fuera de Minha IA y recuperar conocimiento de esa base de conocimiento.',
