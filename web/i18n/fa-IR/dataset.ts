const translation = {
  ...
  intro1: 'دانش می‌تواند در برنامه Minha IA ',
  ...
  externalAPIPanelDescription: 'API دانش خارجی برای اتصال به یک پایگاه دانش خارج از Minha IA و بازیابی دانش از آن پایگاه دانش استفاده می شود.',
