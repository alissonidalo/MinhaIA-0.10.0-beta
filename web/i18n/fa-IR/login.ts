const translation = {
  ...
  welcome: 'به Minha IA خوش آمدید، لطفا برای ادامه وارد شوید.',
  email: 'آدرس ایمیل',
  ...
  license: {
    tip: 'قبل از شروع Minha IA Community Edition، GitHub را بخوانید',
    link: 'مجوز منبع باز',
  },
  join: 'عضویت',
  joinTipStart: 'شما را دعوت می‌کنیم به',
  joinTipEnd: 'تیم در Minha IA',
  invalid: 'لینک منقضی شده است',
  explore: 'کاوش Minha IA',
