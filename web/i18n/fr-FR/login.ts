const translation = {
  ...
  welcome: 'Bienvenue sur Minha IA, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Minha IA Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Minha IA',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Minha IA',
