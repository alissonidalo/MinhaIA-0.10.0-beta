const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'O prova la versione cloud di Minha IA con quota gratuita',
  },
  overview: {
    title: 'Panoramica',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            'Aiuta i visitatori a capire i dati raccolti dall\'applicazione, vedi la <privacyPolicyLink>Privacy Policy</privacyPolicyLink> di Minha IA.',
      ...
      embedded: {
        ...
        chromePlugin: 'Installa l\'estensione Chrome di Minha IA Chatbot',
        copied: 'Copiato',
        copy: 'Copia',
      },
      qrcode: {
