const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Account Minha IA',
    langGeniusAccountTip: 'Il tuo account Minha IA e i dati utente associati.',
  ...
  members: {
    ...
    invitationSentTip:
      'Invito inviato, e possono accedere a Minha IA per accedere ai dati del tuo team.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Il servizio di hosting OpenAI fornito da Minha IA ti consente di utilizzare modelli come GPT-3.5. Prima che la tua quota di prova sia esaurita, devi configurare altri fornitori di modelli.',
  ...
  apiBasedExtension: {
    title:
      'Le estensioni API forniscono una gestione centralizzata delle API, semplificando la configurazione per un facile utilizzo nelle applicazioni di Minha IA.',
  ...
  about: {
    ...
    nowAvailable: 'Minha IA {{version}} è ora disponibile.',
    latestAvailable: 'Minha IA {{version}} è l\'ultima versione disponibile.',
  },
  appMenus: {
