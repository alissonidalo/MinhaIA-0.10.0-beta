const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto Minha IA',
    langGeniusAccountTip: 'Twoje konto Minha IA i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do Minha IA, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez Minha IA pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach Minha IA.',
  ...
  about: {
    ...
    nowAvailable: 'Minha IA {{version}} jest teraz dostępny.',
    latestAvailable: 'Minha IA {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
