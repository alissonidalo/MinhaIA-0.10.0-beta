const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją Minha IA ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza Minha IA i pobierania wiedzy z tej bazy wiedzy.',
}
