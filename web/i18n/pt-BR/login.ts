const translation = {
  ...
  welcome: 'Bem-vindo ao Minha IA, faça login para continuar.',
  ...
  setAdminAccount: 'Criar conta na Minha IA',
  ...
  goToInit: 'Se você ainda não possui conta, faça seu cadastro.',
  dontHave: 'Não tem?',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do Minha IA, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no Minha IA',
  invalid: 'O link expirou',
  explore: 'Explorar o Minha IA',
