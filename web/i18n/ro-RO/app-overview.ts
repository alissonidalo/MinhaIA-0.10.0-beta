const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a Minha IA cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a Minha IA.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome Minha IA Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
