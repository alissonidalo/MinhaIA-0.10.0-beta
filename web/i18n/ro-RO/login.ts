const translation = {
  ...
  welcome: 'Bine ai venit la Minha IA, te rugăm să te autentifici pentru a continua.',
  ...
  license: {
    tip: 'Înainte de a începe Minha IA Community Edition, citește',
    link: 'Licența open-source de pe GitHub',
  },
  join: 'Alătură-te',
  joinTipStart: 'Te invităm să te alături echipei',
  joinTipEnd: 'pe Minha IA',
  invalid: 'Link-ul a expirat',
  explore: 'Explorează Minha IA',
