const translation = {
  ...
  welcome: 'Ласкаво просимо до Minha IA, будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском Minha IA Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда Minha IA',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте Minha IA',
