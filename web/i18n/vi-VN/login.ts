const translation = {
  ...
  welcome: 'Chào mừng bạn đến với Minha IA, vui lòng đăng nhập để tiếp tục.',
  email: 'Địa chỉ email',
  ...
  license: {
    tip: 'Trước khi bắt đầu sử dụng Phiên bản Cộng đồng của Minha IA, vui lòng đọc',
    link: 'Giấy phép mã nguồn mở trên GitHub',
  },
  join: 'Tham gia',
  joinTipStart: 'Mời bạn tham gia',
  joinTipEnd: 'đội ngũ tại Minha IA',
  invalid: 'Liên kết đã hết hạn',
  explore: 'Khám phá Minha IA',
